...
def new_capture_process(is_scheduled, credentials, capture_name, 
    ...
    if not is_scheduled: #interactive capture
        start_capture(capture_name, endpoint, rds_name, db_name, start_time, username, password, filters, cm)
        ...
        schedule_process = multiprocessing.Process(target=create_and_run_scheduler, 
            args=(credentials, capture_name, endpoint, rds_name, db_name, start_time, end_time, username, password, filters, ComManager()))
        ...
        schedule_capture(capture_name, db_name, start_time, end_time, endpoint, rds_name, username, password, filters, cm)
          

        return SUCCESS

def create_and_run_scheduler(credentials, capture_name, endpoint, rds_name, db_name, start_time, end_time, username, password, filters, cm):
    scheduler = sched.scheduler(time.time, time.sleep)

    _create_scheduled_event(scheduler, start_capture, 
            (capture_name, endpoint, rds_name, db_name, start_time, username, password, filters, cm), start_time)
...
def start_orphaned_captures(credentials, cm):
    ...
    for (db_name, capture_name, start_time, end_time, status, endpoint, username, password, rds_name, filters) in captures_to_start:
